        ...
        <Col xs={12} md={4}>
          <div className="image-about-about">
            ...
            <p className="about-myth">
              ...
              restore normal function. And the benefits of colonic hydrotherapy
              for fatigue and depression don’t end there.
            </p>
          </div>
        </Col>
        <Col xs={12} md={4}>
          <div className="image-about-about">
            ...
            <p className="about-myth">
              ...
              hydrotherapy can help to treat gas and bloating in a few ways: It
              is the safest and most effective method to remove bowel
              obstructions, so that the colon may pass blocked fecal matter and
              release trapped gas.
            </p>
          </div>
        </Col>
        <Col xs={12} md={4}>
          <div className="image-about-about">
            ...
            <p className="about-myth">
              ...
              environment, low physical activity, and stressful lifestyle may
              lead to dysfunction of this colon function. Colonic hydrotherapy
              is a very effective and simple way to get rid of these toxins.
            </p>
          </div>
        </Col>
      </Row>
        ...
        <Col xs={12} md={4}>
          <div className="image-about-about">
            ...
            <p className="about-myth">
              ...
              directly seen in the skin. Regular sessions with the hose and
              clean diet can clear up acne, psoriasis and eczema, and even a
              single session can give an immediate glow to the skin.
            </p>
          </div>
        </Col>
        <Col xs={12} md={4}>
          <div className="image-about-about">
            ...
            <p className="about-myth">
              ...
              report feeling lighter, emptier, uplifted, cleansed, less bloated,
              and happier and more at ease.
            </p>
          </div>
        </Col>
        <Col xs={12} md={4}>
